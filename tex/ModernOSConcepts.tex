...
%TODO rt patch, stategies

\cite{lfd430}
rt_preempt patch

- brings lower latencies to linux than other preemption methods 
- affects wide parts of the kernel (slowly the patch's changes go to the mainline kernel) also cite man 7 sched
    -> spinlocks become preemptible -> replaced with rtmutexes
    -> priority inheritance is implemented for spinlocks and semaphores
    -> interrupt handlers become preemptible kernel threads -> they can sleep and be scheduled
