...
The according binding rule to differ between them is \mintinline{BI_MATCH_IF()} with \mintinline{c}{EQ} as a first argument.
...
%TODO verknüpfung zu den driver ops_t, regelcount 
