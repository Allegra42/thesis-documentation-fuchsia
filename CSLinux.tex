...
Unfortunately, there is hardly anything known about suitable hardware for a not too complicated test driver within the Pixelbook.

Thus, the decisison was made for an ARM64 based development board with accessable expansion interfaces, the \textbf{HiKey960} which is pictured in figure~\ref{pic:hikey}.
